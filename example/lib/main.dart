...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      builder: OverlayManager.builder, // <-- Use OverlayManagerInit.builder here
      navigatorObservers: [OverlayManagerInit.navigatorObserver], // <-- Add the navigator observer here
      home: const HomePage(),
    );
  }
}
